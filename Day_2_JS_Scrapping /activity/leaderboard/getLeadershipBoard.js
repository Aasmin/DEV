...
function eachMatchHandler(url) {
    ...
    count++;
    request(url, dataReciever); // calls lag diya raho till all calls are not sent
}
function dataReciever(err, res, html) { //after sab calls isdi processing shuru hougi
    console.log(count + " inside response")
