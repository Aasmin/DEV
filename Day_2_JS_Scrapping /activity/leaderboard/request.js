...
let eachMatchHandler = require("./getLeadershipBoard");
...
function parseMatch(html) {
    ...
    for(let i = 0; i < allCards.length; i++) {
        ...
        eachMatchHandler("https://www.espncricinfo.com" + scoreCardLink);   // use => getLeadershipBoard.js file=> pass url
    }
}

// matches => process => print => leaderboard