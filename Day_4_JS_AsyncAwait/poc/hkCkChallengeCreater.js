...
async function fn() {
    try {
        ...
        await GWillBeOpendP;    //main page ke khulne ka wait kiya 
        let addImpWaitP = driver.manage().setTimeouts({ implicit: 10000,pageLoad:10000 });  // add the timeout
        await addImpWaitP;
        let emailPromise = driver.findElement(swd.By.css("#input-1"));
        let passwordPromise = driver.findElement(swd.By.css("#input-2"));   // find both the elements
